...
if ( apply_filters( 'woocommerce_bcash_help_message', true ) ) : ?>
	<div class="updated inline woocommerce-message">
		<p><?php echo esc_html( sprintf( __( 'Help us keep the %s plugin free making a donation or rate %s on WordPress.org. Thank you in advance!', 'woocommerce-bcash' ), __( 'WooCommerce Bcash', 'woocommerce-bcash' ), '&#9733;&#9733;&#9733;&#9733;&#9733;' ) ); ?></p>
